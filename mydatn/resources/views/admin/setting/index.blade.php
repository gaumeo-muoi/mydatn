                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <form method="post" action="{{route('addSetting')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label class="col-md-3 text-md-right col-form-label">Slogan</label>
                                            <div class="col-md-9 col-xl-8">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label
                                                class="col-md-3 text-md-right col-form-label">Phone 1</label>
                                            <div class="col-md-9 col-xl-8">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label
                                                class="col-md-3 text-md-right col-form-label">Phone 2</label>
                                            <div class="col-md-9 col-xl-8">
