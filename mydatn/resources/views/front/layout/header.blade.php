...
<nav class="navbar navbar-expand-lg navbar-light bg-white w-100 navigation" id="navbar">
  <div class="container">
    <a class="navbar-brand font-weight-bold" href="index.html"><img src="front/images/logo.png" alt="Adrian."
        class="img-fluid"></a>
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item dropdown dropdown-slide">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown3">
            <li><a href="{{route('shopIndex')}}">Shop</a></li>
    ...
    <ul class="top-menu list-inline mb-0 d-none d-lg-block" id="top-menu">
      ...
      <li class="dropdown cart-nav dropdown-slide list-inline-item">
        ...
        <div class="dropdown-menu cart-dropdown">
          ...
          <div class="media">
            <a href="#">
              <img class="media-object img- mr-3" src="front/images/shop/cart/cart-1.jpg" alt="image" />
            </a>
          ...
          <div class="media">
            <a href="#">
              <img class="media-object img-fluid mr-3" src="front/images/shop/cart/cart-2.jpg" alt="image" />
            </a>
            <div class="media-body">
              <h6>Skinny Jeans</h6>
              <div class="cart-price">
          ...
          <div class="cart-summary">
            ...
            <div class="text-center cart-buttons mt-3">
              ...
              <a href="{{route('checkout')}}" class="btn btn-small btn-main btn-block">Checkout</a>
            </div>
          </div>
        </div>
      </li>
