        ...
        <div class="row">
              <div class="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left mr-auto">
                <div class="footer-widget">
                    <h4 class="mb-4"><img src="front/images/{{$result['logo']}}" alt="Vaxon." class="img-fluid"></h4>
                    <p class="lead">Iste dolores iure quis excepturi, deserunt praesentium.</p>
                    
                    <div class="">
                      <p class="mb-0"><strong>Location : </strong>{{$result['address']}}</p>
                      <p><strong>Support Email : </strong> {{$result['email1']}}</p>
                    </div>
                </div>
              </div>
