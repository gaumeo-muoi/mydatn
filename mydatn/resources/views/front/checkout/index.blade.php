                      ...
                      <input type="hidden" id="user_id" name="user_id" value="{{$user->id ?? ''}}">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-4">
                              ...
                              <input type="text" name="street_address" class="form-control" id="street" placeholder="">
                           </div>
                        </div>
                         <div class="col-lg-12">
                            <div class="form-group mb-4">
                         ...
                         <div class="col-lg-12">
                            <div class="form-group mb-4">
                              ...
                              <input type="text" name="town_city" class="form-control" id="city" placeholder="Apartment">
                           </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                         ...
                         <div class="col-lg-12">
                            <div class="form-group mb-4">
                              ...
                              <input type="text" name="postcode_zip" class="form-control" id="postcode" placeholder="">
                           </div>
                        </div>
                         <div class="col-lg-12">
                            <div class="form-group mb-4">
               ...
               <div class="product-checkout-details mt-5 mt-lg-0">
                     ...
                     <form action="#">
                        <div class="form-check mb-3">
                          <input class="form-check-input" type="radio" name="payment_type" value="pay_later" id="exampleRadios1" checked>
